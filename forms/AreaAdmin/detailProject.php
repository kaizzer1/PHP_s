          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center"><?php echo $f['type']?></p>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>GitHub</b> <a class="float-right"><?php echo $f['git']?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Nome do Cliente</b> <a class="float-right"><?php echo $f['name_client']?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Data de Inicio</b> <a class="float-right"><?php echo $f['date_start']?></a>
                  </li>
                  <li class="list-group-item">
